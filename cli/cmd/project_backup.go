...
// projectBackupCmd represents the backup command
...
func init() {
	...
	projectBackupCmd.Flags().StringVarP(&password, "password", "p", "", "password to encrypt backup with")
	projectBackupCmd.Flags().StringVarP(&backupName, "name", "n", "", "name of the backup file")
	projectBackupCmd.Flags().BoolVar(&short, "short", false, "short output, for use in scrpits")
}
