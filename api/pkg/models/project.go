...
type Project struct {
	...
	TTL                 int             `json:"ttl"                    gorm:"column:ttl;not null;default:7"                                        default:"7" faker:"7"`
	DaysBeforeTTLExpiry int             `json:"days_before_ttl_expiry" gorm:"column:days_before_ttl_expiry;not null;default:2"                     default:"2" faker:"2"`
