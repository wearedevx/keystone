...
VALUES
  ...
  (4,  1, 3, false, false, false, current_timestamp, current_timestamp),
  -- developer (invite)
  (5,  2, 1, true, true, true, current_timestamp, current_timestamp),
  (6,  2, 2, false, false, false, current_timestamp, current_timestamp),
  (8,  2, 3, false, false, false, current_timestamp, current_timestamp),
  -- devops
  (9,  3, 1, true, true, true, current_timestamp, current_timestamp),
  (10, 3, 2, true, true, false, current_timestamp, current_timestamp),
  (12, 3, 3, true, true, false, current_timestamp, current_timestamp),
  -- admin
  (13, 4, 1, true, true, true, current_timestamp, current_timestamp),
  (14, 4, 2, true, true, true, current_timestamp, current_timestamp),
  (16, 4, 3, true, true, true, current_timestamp, current_timestamp);
